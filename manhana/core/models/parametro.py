...
class CHSemanalCategoriaAtividade(models.Model):
    categoria_atividade = models.ManyToManyField(CategoriaAtividade, related_name='categoria_atividade_chsmaxima_fk')
    grupo_docente = models.ManyToManyField('authentication.GrupoDocente', related_name='grupo_docente_chmaxima_fk')
...
class Atividade(models.Model):
    ...
    categoria_atividade = models.ForeignKey(CategoriaAtividade, related_name='categoria_atividade_fk',\
...
class ArgumentoCategoria(models.Model):
    ...
    categoria_atividade = models.ManyToManyField(CategoriaAtividade)
...
class FluxoProcesso(models.Model):
    ...
    tipo_processo = models.ForeignKey(CategoriaProcesso, on_delete=models.PROTECT, related_name='fluxo_processos')
    tipo_fluxo = models.CharField('Tipo do fluxo do processo', max_length=5, default=PRINCIPAL,choices=TIPO_FLUXO_PROCESSO)
    unidade = models.ForeignKey(EstruturaOrganizacional, on_delete=models.PROTECT, related_name='fluxo_processo_unidade', blank=True, null=True)
...
class VinculoServidorUnidade(models.Model):
    ...
    servidor = models.ForeignKey('authentication.ServidorProfile', on_delete=models.PROTECT, related_name='servidores_unidade')
